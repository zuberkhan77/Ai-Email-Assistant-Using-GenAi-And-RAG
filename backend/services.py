...
def get_gmail_credentials():
    ...
    if not client_id or not client_secret:
        raise RuntimeError(
            "Gmail OAuth credentials are missing from .env"
        )
